...
import '../../user_exist_result_model.dart';
import '../../user_info_result_model.dart';
...
class UserApi {
  ...
  Future<AuthResultModel?> sendVerificationEmail(
  ...
  Future<AuthResultModel?> completeRegister(
